...
namespace Project2
{
    ...
    {
        public AllCustomers(string x, string y)
        {
            InitializeComponent();
            name.Text = x;
            right.Text = y;
        ...
        //Preview All Customers Information and Get Num. of Customers
        private void AllCustomers_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                command.CommandText = "select [Cus_ID] from Customers";
                ...
                {
                    customerscount.Add(table.Rows[i][0].ToString());
                }
                total.Text = customerscount.Count.ToString();
                ...
                command1.CommandText = "select[Cus_Name] as 'اسم العميل', [Cus_Phone] as 'رقم العميل' from Customers";
